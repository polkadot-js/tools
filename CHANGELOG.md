...
Changes:
- Bump polkadot-js dependencies([#632](https://github.com/polkadot-js/tools/pull/632))


## 0.63.16 Sep 24, 2025

Changes:
- Bump polkadot deps([#630](https://github.com/polkadot-js/tools/pull/630))
...
Changes:
- Bump polkadot deps([#626](https://github.com/polkadot-js/tools/pull/626))
